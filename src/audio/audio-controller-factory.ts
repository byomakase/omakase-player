...
import {AudioBufferAudioTrackController, type AudioTrackController, MediaElementAudioTrackController} from './audio-track-controller';
import type {AudioState, TrackState} from '../media';
...
export class AudioControllerFactory {
  static create(trackState: TrackState, playerController: PlayerController): AudioTrackController {
    ...
    if (BrowserProvider.instance.isSafari) {
      ...
      return new MediaElementAudioTrackController(trackState as AudioState, playerController);
    }
  }
}
