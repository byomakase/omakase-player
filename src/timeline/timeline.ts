...
import {Destroyable, ThumbnailVttCue, TimelineScrollEvent, TimelineZoomEvent, VideoLoadedEvent} from "../types";
...
export class Timeline extends BaseComponent<TimelineConfig, TimelineStyle, Konva.Stage> implements OnMeasurementsChange, HasRectMeasurement, ScrollableHorizontally, TimelineApi {
    ...
    protected createCanvasNode(): Konva.Stage {
        ...
        [this.timecodedBackground, this.timecodedEventCatcher,
            this.timecodedBaseGroup, this.timecodedThumbnailsGroup, this.timecodedSubtitlesGroup, this.timecodedAudioGroup, this.timecodedMarkersGroup, this.timecodedSurfaceGroup
        ].forEach(node => {
        ...
        this.playheadHover = new PlayheadHover({}, this);
    ...
    private calculateHeights(): { bodyHeight: number, layoutHeight: number } {
    ...
    destroy() {
        ...
        let destroyables: Destroyable[] = [this.scrollbar, this.playheadHover, this.playhead, ...this.timelineLanes, this.thumbnailHover, this.headerTimecodeDisplay]
