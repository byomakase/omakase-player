...
const configDefault: ObservationTrackLaneConfig = {
...
export enum ObservationTrackLaneEventType {
  ...
  // TIMELINE_OBSERVATION_TRACK_LANE_ITEM_MOUSE_ENTER = 'TIMELINE_OBSERVATION_TRACK_LANE_ITEM_MOUSE_ENTER',
  // TIMELINE_OBSERVATION_TRACK_LANE_ITEM_MOUSE_LEAVE = 'TIMELINE_OBSERVATION_TRACK_LANE_ITEM_MOUSE_LEAVE',
  //
  // TIMELINE_OBSERVATION_TRACK_LANE_ITEM_HANDLE_CLICK = 'TIMELINE_OBSERVATION_TRACK_LANE_ITEM_HANDLE_CLICK',
  // TIMELINE_OBSERVATION_TRACK_LANE_ITEM_HANDLE_MOUSE_ENTER = 'TIMELINE_OBSERVATION_TRACK_LANE_ITEM_HANDLE_MOUSE_ENTER',
  // TIMELINE_OBSERVATION_TRACK_LANE_ITEM_HANDLE_MOUSE_LEAVE = 'TIMELINE_OBSERVATION_TRACK_LANE_ITEM_HANDLE_MOUSE_LEAVE',
  //
  // TIMELINE_OBSERVATION_TRACK_LANE_ITEM_IN_FOREGROUND_CHANGE = 'TIMELINE_OBSERVATION_TRACK_LANE_ITEM_IN_FOREGROUND_CHANGE',
}

export interface ObservationTrackLaneEventData {
