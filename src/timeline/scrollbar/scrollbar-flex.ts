...
import {type ScrollableHorizontally, ZoomScrollbar, ZoomScrollbarEventType} from './zoom-scrollbar';
...
export class ScrollbarFlexContentNode extends KonvaComponentFlexContentNode2<ZoomScrollbar> {
  private _scrollableHorizontally: ScrollableHorizontally;

  constructor(component: ZoomScrollbar, scrollableHorizontally: ScrollableHorizontally) {
    super(component);
...
export class ScrollbarFlexItem extends KonvaFlexItem<ScrollbarFlexContentNode> {
  constructor(config: FlexGroupConfig, scrollbar: ZoomScrollbar, scrollableHorizontally: ScrollableHorizontally) {
...
export class TimelineScrollbar extends ScrollbarFlexItem {
  ...
  private _scrollbar: ZoomScrollbar;

  private _timelineZoomInProgress = false;

  protected _destroyBreaker = new ObserverBreaker();

  constructor(config: FlexGroupConfig, scrollbar: ZoomScrollbar, timeline: TimelineImpl) {
